      ...
      <div class="left">
        ...
        <div class="map">
          <div class="map-title">
            ...
            <div class="total">
              <div class="text-center" style="margin-top: 1.7vh;font-size: .625vw;color: #99e2ff;">今日运行团队数量</div>
              <div class="sides-num">
          ...
          <baidu-map class="map" id="map" :center="center" :zoom="zoom" @ready="handler">
            ...
            <my-overlay :marker="currentMarkerObj" @ShowScreen="ShowScreen"
                        v-show="currentMarkerObj!=null"></my-overlay>
            <bml-heatmap :data="heatdata" :max="200" :radius="30" v-if="markerType=='wifi'">
            </bml-heatmap>

            <bm-marker autoPan :key=index @click="markerClick(marker)" v-for="(marker,index) in markers"
                       :title="marker.name" v-if="marker.type==markerType" :position="marker.position"
                       :icon="currentMarker==marker.name?{url:'statics/images/icon-pinA.png',size: {width: 30, height: 35}}:marker.icon">
